...
//!
//! Performs the alignment of two sequences and their
...
protected:
    ...
    */
    ...
    /**
     * Provides a modified view on the scoring This view is used when
     * computing length normalized local alignment.  
     * @see UnmodifiedScoringView
     * @todo It does not make much sense to derive this class
     * from UnmodifiedScoringView
     */
