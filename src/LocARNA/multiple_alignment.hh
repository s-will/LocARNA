...
namespace LocARNA {
    ...
    public:
        ...
        public:
            ...
            /**
             * @brief Construct from strings name, description and 1-based
             * string seq
             *
             * @param name Sequence name
             * @param description Sequence description
            ...
            */
             ...
             *   if column col contains a non-gap, then pos1=pos2 is the
             * position of the gap
             *   if column col contains a gap, then pos1 is the sequence
             * position left of the gap or 0 and pos2 the position right of the
             * gap or sequence length+1
            */
            pos_pair_t
         ...
         *
         * Allow read only access to the symbols in the column by their row
         * index
         */
        class AliColumn {
    ...
    public:
        ...
        */
        ...
        /**
         * @brief Construct as pairwise alignment from names and alignment
         * strings
         ...
         *
         * @note handling of gap-symbols: use same gap symbols as in given
         * alistrings
         */
        ...
        */
        ...
        /**
         * @brief Sum-of-pairs score between a multiple alignment and a
         * reference alignment
         *
         * @param ma multiple alignment
        ...
        */
        ...
        /**
         * @brief Cmfinder realignment score of a multiple alignment to a
         * reference alignment
         *
         * @param ma multiple alignment
         *
        ...
        */
         ...
         * @param ma multiple alignment
         *
         * @return average deviation fo alignment ma to reference alignment
         *this
         *
         * @pre the sequences of ma have to occur in the alignment *this
         ...
         * @param format alignment format; only CLUSTAL or STOCKHOLM; default:
         * CLUSTAL (@see FormatType)
         *
         * @return output stream
         *
         * Writes one line "<name> <seq>" for each sequence; moereover, writes
         * annotations.
         *
    ...
    private:
        ...
        *
        * @return alignment comparison match score for pairwise alignments
        * (a1,a2) and (ref1,ref2)
        *
        * @see sps()
        */
        ...
        match_vector(const string1 &s, const string1 &t);
         ...
         */
        static std::vector<int>
        match_vector2(const string1 &s, const string1 &t);
         ...
         */
        static size_t
        count_matches(const SeqEntry &a1, const SeqEntry &a2);
