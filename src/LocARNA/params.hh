...
namespace LocARNA {
    ...
    */
	...
	bool struct_local_; //!< allow exclusions for maximizing alignment of connected substructures 
	...
	const TraceController *trace_controller_; //!< trace controller controlling allowed trace cells
	 ...
	 */
	AlignerParams &
	seqA(const Sequence &seqA) {seqA_=&seqA; return *this;}
	 ...
	 */
	AlignerParams &
	seqB(const Sequence &seqB) {seqB_=&seqB; return *this;}
	 ...
	 */
	AlignerParams &
	arc_matches(const ArcMatches &arc_matches) {arc_matches_=&arc_matches; return *this;}
	 ...
	 */
	AlignerParams &
	no_lonely_pairs(bool no_lonely_pairs) {no_lonely_pairs_=no_lonely_pairs; return *this;}

	/**
	 * @brief set parameter struct_local
	 * @param struct_local allow exclusions for maximizing alignment of connected substructures 
	 */
	AlignerParams &
	struct_local(bool struct_local) {struct_local_=struct_local; return *this;}
	
	/**
	 * @brief set parameter sequ_local
	 * @param sequ_local  sequence local alignment / maximize alignment of subsequences
	 */
	AlignerParams &
	...
	free_endgaps(const std::string &free_endgaps) {
	    free_endgaps_=free_endgaps; return *this;}
	 ...
	 */
	AlignerParams &
	DO_TRACE(bool DO_TRACE) {DO_TRACE_=DO_TRACE; return *this;}

	/**
	 * @brief set parameter trace_controller
	 * @param trace_controller  trace controller controlling allowed trace cells
	 */
	AlignerParams &
	 ...
	 */
	AlignerParams &
	max_diff_am(int max_diff_am) {max_diff_am_=max_diff_am; return *this;}
	...
	constraints(const AnchorConstraints &constraints) {
	    constraints_=&constraints; return *this;}
	 ...
	 */
	AlignerNParams &
	sparsification_mapperA(const SparsificationMapper &sparsification_mapperA) {
