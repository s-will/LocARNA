...
namespace LocARNA {
    ...
    */
    ...
    public:
         ...
         */
        InftyInt(const TaintedInftyInt &x) : TaintedInftyInt(x) { normalize(); }
    ...
    */
    ...
    public:
         ...
         */
        FiniteInt(base_type x) : InftyInt(x) { assert(is_finite()); }
    ...
    inline InftyInt::InftyInt(const FiniteInt &x) : TaintedInftyInt(x) {}
